...
public class VuforiaSkyStoneTrack
{
    ...
    public void init( HardwareMap hardwareMap )
    {
        ...
        final float CAMERA_FORWARD_DISPLACEMENT  = (float)0.75 * mmPerInch;   // eg: Camera is 4 Inches in front of robot center
        final float CAMERA_VERTICAL_DISPLACEMENT = 11 * mmPerInch;   // eg: Camera is 8 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = (float)3.75*mmPerInch;     // eg: Camera is ON the robot's center line
